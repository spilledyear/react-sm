      ...
      render: (text, record) => (
        <span>
          <a href="javascript:void(0)" onClick={function(record){
            ...
            alert('Haha,the function is no use');
      ...
      <div className="sup-body">
         <div style={{height:40}}>
          <span style={{float:"left"}}>
            <SearchInput placeholder="请输入字段1关键字" onSearch={value => alert('Haha,the function is no use')} style={{ width: 300 }}/>
          </span>
